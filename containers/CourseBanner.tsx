  ...
  return (
    <div className="max-w-7xl mx-auto mt-10 lg:mt-20 md:px-4 lg:px-0">
      <div className="flex flex-col md:flex-row ">
        ...
        <div className="flex flex-col lg:h-[25rem] md:h-[28rem] items-center md:items-start space-y-4 pt-6 md:pt-0 md:ml-6  flex-1 lg:ml-16">
          <div className="w-[93%] md:w-[100%] self-center md:self-start pl-2 md:pl-0">
          ...
          <div className="lg:w-[95%] w-[90%] max-h-[7rem] h-[7rem] md:h-[9rem] md:max-h-[9rem] lg:max-h-[13rem] lg:h-[13rem] overflow-y-scroll scrollbar-thin scrollbar-thumb-red-500 scrollbar-track-gray-200 scrollbar-thumb-rounded-full scrollbar-track-rounded-full  scrollbar-thumb-h-[2rem]  scrollbar-w-[0.3rem] md:scrollbar-w-[0.2rem] ml-2">
            <p className="tracking-wide text-[0.9rem] lg:text-[1rem] font-poppins text-stone-600 pr-[0.8rem]">
              {props?.data?.Course?.description}
            </p>
          </div>
          <div className="hidden lg:flex w-[90%] pt-6 flex-wrap md:w-[50%] self-start ml-5 flex-row lg:pt-2 lg:ml-1 lg:justify-between">
          ...
          <div className="flex flex-row px-5 md:px-2 lg:hidden">
